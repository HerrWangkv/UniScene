...
def eval_single_ckpt(model, test_loader, args, eval_output_dir, logger, dist_test=False, result_tag=""):
    ...
    eval_utils.eval_one_epoch(
        cfg, args, model, test_loader, logger, dist_test=dist_test,
        result_dir=eval_output_dir, result_tag=result_tag
    )
...
def main():
    ...
    with torch.no_grad():
        eval_single_ckpt(model, test_loader, args, eval_output_dir, logger, dist_test=dist_test, result_tag=args.result_tag)
