...
def main(args):
    ...
    dataset = CustomDataset_Tframe_12hz(imageset,occ_base_path,bev_path,bev_ch_use,meta_num=4,Tframe=Tframe,use_clip=True,return_token=True)
        ...
        for i_iter_val, (occ_ori,y,occ_meta, pose_meta,tokens,bev_ori) in enumerate(tqdm(loader)):
            ...
            if vis:
                ...
                for i in range(Tframe):
                    ...
                    # 
                    cat_image=draw_nusc_occupancy_Bev_Front(voxels=pred_i, 
